...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
	...
	[RecentPhoto clearNSUserDefaults];
	...
	RecentlyViewedPhotoController *rptvc = [[RecentlyViewedPhotoController alloc]init];
	
	rptvc.title = @"Recently Viewed";
	UINavigationController *nav2 = [[UINavigationController alloc] init];
	[nav2 pushViewController:rptvc animated:NO];
	[rptvc release];
	
	self.tbc = [[UITabBarController alloc] init];
	self.tbc.viewControllers = [NSArray arrayWithObjects:nav, nav2, nil];
	[nav release];
	[nav2 release];
	[window addSubview:self.tbc.view];	
